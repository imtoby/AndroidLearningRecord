...
public class CustomScannerView extends ViewfinderView {
    ...
    public int[] colors = new int[]{0x000079d5, 0xff0079d5, 0x000079d5};
    public LinearGradient linearGradient;

    public CustomScannerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        // 绘制4个角
        paint.setColor(0xFF0079D5);//定义画笔的颜色
        ...
        canvas.drawRect(frame.left, frame.bottom, frame.right, frame.bottom + 1, paint);
        canvas.drawRect(frame.left, frame.top, frame.left + 1, frame.bottom, paint);
        canvas.drawRect(frame.right, frame.top, frame.right + 1, frame.bottom, paint);
...
//            int middle = frame.height() / 2 + frame.top;
            ...
            canvas.drawRect(
                    ...
                    frame.top + laserLinePosition,
                    frame.right - 1,
                    frame.top + 10 + laserLinePosition, paint);
